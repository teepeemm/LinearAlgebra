...
\hypertarget{scripts_elementary_matrices_permutations}{Let's try to get the hang of} permutations. A permutation is a function which scrambles things. Suppose we had
