...
\item \label{hatsum} Let $\hat\sigma$ denote the permutation obtained from $\sigma$ by transposing the first two outputs, {\itshape i.e.} $\hat \sigma(1)=\sigma(2)$ and $\hat \sigma(2)=\sigma(1)$. Suppose the function $f:\{1,2,3,4\}\to {\mathbb R}$. Write out explicitly the following two sums:
\[
