...
\begin{center}
\includegraphics[alt={Perpendicular vectors vi and vj.},scale=.4]{\orthonormPath/rightangles.jpg}
\end{center}
...
To complete the hint, let's use the dot product to compute a formula for $c^1$ in terms of the basis vectors and $v$. Consider
\[
