...
\noindent{\bfseries Background Reading:}
...
\noindent{\bfseries Other Resources:}
\begin{itemize}
...
Let's sketch an example. Consider $y=f(x)$ and think about the slope at a point $x_0$ where the function
