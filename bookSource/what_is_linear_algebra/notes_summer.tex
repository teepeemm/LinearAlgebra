...
Section 1.1. 
Lets call any equation of the form~$Mu=v$ with~$M$ a matrix, and~$u,v$ vectors a {\itshape matrix equation}\index{matrix equation}. The first part of this course is dedicated to the study of matrix equations. 
