...
In equation~\eqref{linsys} we have $n$ {\itshape linear} functions called $f_1,\ldots, f_n$, $m$ un\-knowns $x_1,\ldots, x_m$
and $n$ given constants $a_1,\ldots,a_n$. We need to say what it means for a function to be linear.
A linear function has the {\itshape additive property}
\[
f(a+b)=f(a)+f(b)\, .
\]
