...
\]
This means we are going to have an idea of what $A^n$ looks like for any $n$. Let's look at the example of one of the matrices in the problem. Let
\[
A = 
\left( 
\begin{array}{cc}
...
Let's compute $A^n$ for the first few $n$. 
\begin{align*}
A^0 & =
\left(
\begin{array}{cc}
