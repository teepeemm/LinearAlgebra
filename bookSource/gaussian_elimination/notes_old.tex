...
%It was nice to do this elimination by adding, subtracting, and multiplying wholes equations at a time. 
...
Let's write them side by side as we solve the system using a nice algebra trick: we will strategically add and subtract  equations.
