...
So this question is really about the word {\itshape same}. Let's do a silly example:
Let's replace the set of augmented matrices by the set of people who have hair.
...
\begin{center}
\includegraphics[alt={Two identical people joined by a tilde.},scale=.15]{bobbob.jpg}
\end{center}
...
\begin{center}
\includegraphics[alt={Two different people joined by a tilde.  Implies that the same people swapped are also joined by a tilde.},scale=.15]{bobbetty.jpg}
\end{center}
...
\begin{center}
\includegraphics[alt={Bob and Betty joined by a tilde and Betty and Brenda joined by a tilde implies Bob and Brenda are joined by a tilde.},scale=.24]{bobbettybrenda.jpg}
\end{center}
\end{itemize}
