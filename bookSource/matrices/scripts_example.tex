...
\hypertarget{scripts_matrices_example}{Let's think about a graph as a mini-facebook.} In this tiny facebook there are only four people, Alice, Bob, Carl, and David. 
...
We can continue to label the entries for each friendship. Here let's assume that people are friends with themselves, so the diagonal will be all ones.
