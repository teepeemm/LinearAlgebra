...
\item \label{3rdPoly} number of points required to specify a third order polynomial $\mathbb{R}\to \mathbb{R}$.
\item number of points required to specify a third order homogeneous polynomial $\mathbb{R}\to \mathbb{R}$.
\item number of points required to specify a n-th order polynomial $\mathbb{R}\to \mathbb{R}$.
\item number of points required to specify a n-th order homogeneous polynomial $\mathbb{R}\to \mathbb{R}$.\\
