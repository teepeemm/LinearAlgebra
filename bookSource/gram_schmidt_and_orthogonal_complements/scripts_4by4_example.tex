...
\hypertarget{scripts_gram_schmidt_and_orthogonal_complements_4by4_example}{Let's do an example} of how to ``Gram-Schmidt'' some vectors in $\mathbb{R}^4$. Given the following vectors
\[
