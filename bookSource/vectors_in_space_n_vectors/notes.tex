...
\begin{example} of the dot product of two vectors from $\mathbb{R}^{100}$.
...
\begin{example} 
of the norm of a vector from $\mathbb{R}^{101}$.\\
...
\begin{example} of an angle between two vectors form $\mathbb{R}^{101}$.\\
...
\begin{example} of vectors from $\mathbb{R}^{101}$ that are orthogonal to each other.\\
\[
...
\section{Vectors, Lists and Functions: $\mathbb{R}^S$}
