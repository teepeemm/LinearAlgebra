...
as shown:
\begin{center}
\includegraphics[alt={A plane with horizontal axis x and vertical axis t.  The lines t=±x are drawn, corresponding to light.  Your world line is a curve starting at the origin and moving where t>abs(x).},scale=.2]{worldline.jpg}
\end{center}
