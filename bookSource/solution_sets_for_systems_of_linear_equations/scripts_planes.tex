...
\begin{center}
\includegraphics[alt={The plane N dot V = d has a normal vector N.  A homogeneous solution c lies in the plane and is perpendicular to N.  A particular solution v0 points to the tail of N and c.  A general solution is v=v0+c.},scale=.2]{plane1eq.jpg}
\end{center}
...
ax+by+cz=d\, .
\]
Let's simplify this by calling $V=(x,y,z)$ the vector of unknowns and $N=(a,b,c)$. Using the dot product in ${\mathbb R}^3$
we have
\[
N\dotprod V = d\, .
\]
Remember that when vectors are perpendicular their dot products vanish. {\itshape I.e.} $U\dotprod V = 0 \Leftrightarrow U \perp V$.
