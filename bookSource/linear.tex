...
% latexml --nocomments --destination=linear.xml --preload=LaTeX.pool linear
...
\providecommand{\NewSocket}[2]{}
\providecommand{\NewSocketPlug}[3]{}
\providecommand{\AssignSocketPlug}[2]{}
\providecommand{\SuspendTagging}{}
\providecommand{\ResumeTagging}{}
\providecommand{\UseTaggingSocket}[1]{}
\ExplSyntaxOn
\providecommand{\tag_mc_end_push:}{}
\providecommand{\tag_mc_begin:n}[1]{}
\providecommand{\tag_mc_end:}{}
\providecommand{\tag_mc_begin_pop:n}[1]{}
\ExplSyntaxOff
...
\raisebox{-3mm}{\includegraphics[alt={eyeglasses},scale=.1]{glasses.jpg}}\hspace{2mm}\sffamily \hypertarget{#1#2}{Reading homework:} problem #1.#2}\hspace{8mm}\end{center}}
