...
\iflatexml
 \newcommand*{\shabox}[1]{\parbox{\textwidth}{\lxAddClass{shabox}#1}}
\else
% \usepackage{titlesec}
...
%	before upper={\setlength{\parindent}{14pt}},
 ...
 \usepackage{table-header-scope} % work around a PAC bug
...
\begin{center}
\href{\videourl #1}{\raisebox{-.4cm}{\includegraphics[alt={movie clapper board},scale=.075]{take1.jpg}}} \hspace{1cm}\scalebox{1.2}{\ttfamily #2}
\end{center}
} 
...
\begin{center}
\href{\videourl #1}{\raisebox{-.4cm}{\includegraphics[alt={movie clapper board},scale=.075]{take1.jpg}}} \hspace{1cm}\scalebox{1.2}{\ttfamily #2}
\hspace{1cm} \hyperlink{#3}{\raisebox{-.3cm}{\includegraphics[alt={movie script},scale=.08]{script.jpg}}}
\end{center}
} 
...
\raisebox{-3mm}{\includegraphics[alt={eyeglasses},scale=.1]{glasses.jpg}}%
\hspace{2mm}\sffamily
\hypertarget{#1#2}{Reading homework:}%
problem #1.#2%
}\hspace{8mm}%
\end{center}}
%\newcommand{\Reading}[2]{\begin{center}
%\href{\webworkurl ReadingHomework#1/#2/}{
%\raisebox{-3mm}{\includegraphics[alt={eyeglasses},scale=.1]{glasses.jpg}}\hspace{2mm}\sffamily \hypertarget{#1#2}{Reading homework:} problem #2}\hspace{8mm}%\end{center}}

\iflatexml
 \makeatletter
  \newcommand{\Reading}{\@ifstar\Reading@yes@star\Reading@no@star}
  \newcommand{\Reading@yes@star}[2]{\begin{center}%
   \href{\webworkurl #1/#2/}{%
    \raisebox{-3mm}{\includegraphics[alt={eyeglasses},scale=.1]{glasses.jpg}}%
    \hspace{2mm}\sffamily Reading homework: problem #2%
   }%
   \hspace{8mm}\end{center}
  }
  \newcommand{\Reading@no@star}[2]{\begin{center}%
   \href{\webworkurl #1/#2/}{%
    \raisebox{-3mm}{\includegraphics[alt={eyeglasses},scale=.1]{glasses.jpg}}%
    \hspace{2mm}\sffamily\hypertarget{#1#2}{Reading homework:} problem #2%
   }%
   \hspace{8mm}\end{center}
  }
 \makeatother
\else
 \NewDocumentCommand{\Reading}{smm}{\begin{center}
  \href{\webworkurl #2/#3/}{%
   \raisebox{-3mm}{\includegraphics[alt={eyeglasses},scale=.1]{glasses.jpg}}%
   \hspace{2mm}\sffamily
   \IfBooleanTF{#1}{Reading homework:}{\hypertarget{#2#3}{Reading homework:}}%
   problem #3%
  }\hspace{8mm}%
  \end{center}%
 }
...
\newcommand{\hwrref}[2]{\href{\webworkurl #1/#2}{#2}\hyperlink{#1#2}{\raisebox{-1.5mm}{\includegraphics[alt={eyeglasses},scale=.05]{glasses.jpg}}}}
...
\newcommand{\takeone}{\raisebox{-.4cm}{\includegraphics[alt={movie clapper board},scale=.075]{take1.jpg}}}
...
\noindent
\href{http://creativecommons.org/licenses/by-nc-sa/3.0/deed.en_US}{\includegraphics[alt={CC-BY-NC-SA logo},scale=.7]{cc.jpg}}
...
%\input{\gaussElimPath/scripts_hint} % why was this here?  it repeats 12 lines previous
