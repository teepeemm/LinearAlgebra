...
\raisebox{-3mm}{\includegraphics[scale=.1]{glasses.jpg}}\hspace{2mm}\sffamily \hypertarget{#1#2}{Reading homework:} problem #1.#2}\hspace{8mm}\end{center}}
...
\newcommand\tolinear{{\stackrel{\rm linear}{-\!\!\!-\!\!\!-\!\!\!\rightarrow}}}
\newcommand\nn{\nonumber}
