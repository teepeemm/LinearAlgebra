...
\begin{definition}
We say that a subset $U$ of a vector space $V$ is a {\bfseries subspace}\index{Subspace} of $V$ if $U$ is a vector space under the inherited addition and scalar multiplication operations of $V$. 
\end{definition}
...
\begin{center}
\includegraphics[alt={A plane P in space with vectors x1 and x2 in the plane which combine as ux1+vx2.  The vector (a,b,c) is perpendicular to the plane.},scale=.3]{\subspacesPath/subspace_plane.jpg}
\end{center}
...
\begin{center}
\includegraphics[alt={A plane P with vectors u and v starting from the point O},scale=.3]{\subspacesPath/span_plane.jpg}
\end{center}
 In this case, the vectors in $U$ define the $xy$-plane in $\mathbb{R}3$.  We can view the $xy$-plane as the set of all vectors that arise as a linear combination of the two vectors in $U$.  We call this set of all linear combinations the \emph{span}\index{Span} of $U$:
\[
